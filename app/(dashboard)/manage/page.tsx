...
function page() {
  return (
    ...
    <div className="border-b bg-gray-600/5">
      <div className="container mx-auto flex flex-wrap items-center justify-between gap-6 py-8 px-4 md:px-6 ">
        <div>
        ...
        <CardHeader>
          <CardTitle className='flex items-center justify-between gap-2'>
            <div className="flex items-center gap-2">
              {type === "expense" ? <TrendingDown className='h-12 w-12 items-center rounded-lg bg-red-400/10 text-red-500
...
function CategoryCard({category} : {category : Category}){
  return(
    <div className="fley border-separate flex-col justify-between rounded-md border shadow-md shadow-black/[0.1] dark:shadow-white/[0.1]">
