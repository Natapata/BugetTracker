...
function History({userSettings}: {userSettings : UserSettings}) {
  ...
  return (
    <div className="container mx-auto px-4 md:px-6">
        ...
        <Card className='col-span-12 mt-2 w-full bg-gray-300/2'>
            ...
            <CardContent>
                <SkeletonWrapper isLoading={historyDataQuery.isFetching}>
                    ...
                    {!dataAvailable && (
                        <Card className='felx h-[300px] flex-col items-center justify-center bg-background'>
...
function CustomToolTip({active, payload, formatter}: any){
    ...
    return(
        <div className="min-w-[300px] rounded border bg-background p-4">
            <TootipRow formatter={formatter} label="Income" value={income} bgColor="bg-emerald-500" textColor="text-emerald-500" />
            <TootipRow formatter={formatter} label="Expense" value={expense} bgColor="bg-red-500" textColor="text-red-500" />
            <TootipRow formatter={formatter} label="Balance" value={income-expense} bgColor="bg-violet-500" textColor="text-violet-500" />
        </div>
    )
}

function TootipRow({formatter, label, value, bgColor, textColor}: {
    label: string,
    textColor: string,
    bgColor: string,
    value: number
